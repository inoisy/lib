...
function destroy(el) {
    ...
    if (ctx !== void 0) {
        ...
        ctx.isFirefox === true && preventDraggable(el, false);
...
export default {
    ...
    bind(el, { value, arg, modifiers }) {
        ...
        const hasTouch = window.$nuxt.$device.hasTouch;
        const isFirefox = window.$nuxt.$device.isFirefox;
        ...
        const ctx = {
            ...
            start(evt, mouseEvent) {
                isFirefox === true && preventDraggable(el, true);
            ...
            velX > ctx.sensitivity[0]
                ...
                cleanEvt(ctx, 'temp');
                isFirefox === true && preventDraggable(el, false);
