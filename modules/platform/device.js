...
function extractDevices(req, userAgent) {
    ...
    return { mobile, mobileOrTablet, isSafari, isFirefox, isEdge, isChrome, isSamsung };
}
...
export default function getDeviceFromRequest(req, options) {
    ...
    const { mobile, mobileOrTablet, isSafari, isFirefox, isEdge, isChrome, isSamsung } = extractDevices(req, userAgent);
