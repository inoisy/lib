...
import { getPropertyFromItem, getObjectValueByPath, keyCodes } from '../../../utils/helpers';
...
export default baseMixins.extend().extend({
    ...
    props: {
        ...
        attach: {
            //   type: null  as PropType<string | boolean | Element | VNode>,
            //   default: false,
        },
        cacheItems: Boolean,
        chips: Boolean,
    ...
    methods: {
        ...
        selectItem(item) {
            if (!this.multiple) {
                ...
                this.setValue(internalValue.map(i => this.returnObject ? i : this.getValue(i)));
