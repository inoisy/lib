...
import VDialog from '../../VDialog/index';
import {
    VListItem,
    VListItemTitle,
    VListItemContent,
...
/* eslint-disable no-prototype-builtins,vue/one-component-per-file,max-statements */
describe('VSelect.js', () => {
    let mountFunction;
    let el;
    ...
    beforeEach(() => {
        ...
        mountFunction = (options = {}) => mount(VSelect, {
    ...
    it('should cycle through selected items as per kep up & down without closing hosting menu dialog', async () => {
        ...
        const selectWrapper = dialogWrapper.find({ name: 'v-select' });
