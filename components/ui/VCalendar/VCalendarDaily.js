    ...
    methods: {
        ...
        genHeadDay(day, index) {
            return this.$createElement('div', {
                ...
                on: this.getDefaultMouseEventHandlers(':day', _e => this.getSlotScope(day)),
            }, [
        ...
        genBodyIntervals() {
            ...
            const data = {
                ...
                on: this.getDefaultMouseEventHandlers(':interval', e => this.getTimestampAtEvent(e, this.parsedStart)),
            };
