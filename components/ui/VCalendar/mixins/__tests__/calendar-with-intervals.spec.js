...
describe('calendar-with-intervals.js', () => {
    let mountFunction;
    beforeEach(() => {
    ...
    it('should scroll to time', async () => {
        ...
        expect(wrapper.vm.$refs.scrollArea.scrollTop).toBe(408);
        wrapper.vm.scrollToTime('12:30');
        expect(Math.round(wrapper.vm.$refs.scrollArea.scrollTop)).toBe(600);
        ...
        wrapper.vm.scrollToTime('8:30');
        expect(wrapper.vm.$refs.scrollArea.scrollTop).toBe(1152);
        wrapper.vm.scrollToTime('12:30');
        expect(wrapper.vm.$refs.scrollArea.scrollTop).toBe(1152);
        ...
        wrapper.vm.scrollToTime('8:30');
        expect(wrapper.vm.$refs.scrollArea.scrollTop).toBe(816);
        wrapper.vm.scrollToTime('12:30');
        expect(wrapper.vm.$refs.scrollArea.scrollTop).toBe(1152);
        wrapper.vm.scrollToTime('20:30');
        expect(wrapper.vm.$refs.scrollArea.scrollTop).toBe(1152);
    ...
    it('should get timestamp at mouse event', async () => {
        ...
        expect(wrapper.vm.getTimestampAtEvent(createMouseEvent(0, 100), { time: '20:00' })).toMatchObject({ hour: 2, minute: 5 });
        expect(wrapper.vm.getTimestampAtEvent(createMouseEvent(0, 150), { time: '20:00' })).toMatchObject({ hour: 3, minute: 7 });
        expect(wrapper.vm.getTimestampAtEvent(createMouseEvent(0, 200), { time: '20:00' })).toMatchObject({ hour: 4, minute: 10 });
    });
    ...
    it('should get timestamp at touch event', async () => {
        ...
        expect(wrapper.vm.getTimestampAtEvent(createTouchEvent(0, 100), { time: '20:00' })).toMatchObject({ hour: 2, minute: 5 });
        expect(wrapper.vm.getTimestampAtEvent(createTouchEvent(0, 150), { time: '20:00' })).toMatchObject({ hour: 3, minute: 7 });
        expect(wrapper.vm.getTimestampAtEvent(createTouchEvent(0, 200), { time: '20:00' })).toMatchObject({ hour: 4, minute: 10 });
    });
    ...
    it('should show interval label', async () => {
        ...
        expect(wrapper.vm.showIntervalLabelDefault({ hour: 0, minute: 5 })).toBeTruthy();
        expect(wrapper.vm.showIntervalLabelDefault({ hour: 12, minute: 30 })).toBeTruthy();
        expect(wrapper.vm.showIntervalLabelDefault({ hour: 13, minute: 0 })).toBeTruthy();
        expect(wrapper.vm.showIntervalLabelDefault({ hour: 13, minute: 30 })).toBeTruthy();
    });
});
