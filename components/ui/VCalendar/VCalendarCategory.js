    ...
    methods: {
        ...
        genDayHeaderCategory(day, scope) {
            ...
            return this.$createElement('div', {
                ...
                on: this.getDefaultMouseEventHandlers(':day-category', e => this.getCategoryScope(this.getSlotScope(day), scope.category)),
            }, [
        ...
        genDay(day, index, categoryIndex) {
            ...
            return this.$createElement('div', {
                ...
                on: this.getDefaultMouseEventHandlers(':time', e => this.getSlotScope(this.getTimestampAtEvent(e, day))),
            }, [
        ...
        genDayBodyCategory(day, category) {
            const data = {
                ...
                on: this.getDefaultMouseEventHandlers(':time-category', e => this.getCategoryScope(this.getSlotScope(this.getTimestampAtEvent(e, day)), category)),
            };
