...
/* eslint-disable no-eq-null,no-unused-expressions */
export default mixins(Localable, Picker).extend({
    ...
    props: {
        ...
        nextMonthAriaLabel: {
            ...
            // $vuetify.datePicker.nextMonthAriaLabel',
        },
        nextYearAriaLabel: {
            type: String,
        ...
        prevYearAriaLabel: {
            ...
            // '$vuetify.datePicker.prevYearAriaLabel',
        },
        range: Boolean,
        reactive: Boolean,
        readonly: Boolean,
        ...
        selectedItemsText: {
            type: String,
            default: '{0} выбран',
            // '$vuetify.datePicker.itemsSelected',
        },
    ...
    computed: {
        ...
        defaultTitleMultipleDateFormatter() {
            return dates => {
                ...
                return replaceVariablesInTemplate(this.selectedItemsText, String(dates.length));
            };
        },
