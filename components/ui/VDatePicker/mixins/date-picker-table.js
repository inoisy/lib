...
export default mixins(Colorable, Localable, Themeable).extend({
    ...
    computed: {
        computedTransition() {
            ...
            // this.isReversing === this.isReversing === !this.$vuetify.rtl ? 'tab-reverse-transition' : 'tab-transition'
        },
        displayedMonth() {
    ...
    methods: {
        ...
        genTable(staticClass, children, calculateTableDate) {
            const transition = this.$createElement('transition', {
                props: { name: this.computedTransition, mode: '' },
