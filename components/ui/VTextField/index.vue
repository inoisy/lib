...
import VCounter from '../VCounter/index.vue';
...
import { breaking, consoleWarn } from '../../../utils/console';
...
export default baseMixins.extend({
    ...
    computed: {
        classes() {
            return {
                ...
                'v-text-field--error': this.errorMessages?.length,
            };
        },
        computedColor() {
    ...
    created() {
        /* eslint-disable no-prototype-builtins,no-unused-expressions, no-unused-vars */
        ...
        genLabel() {
            ...
            const data = {
                props: {
                    ...
                    focused: !this.isSingle && (this.isFocused || Boolean(this.validationState)),
                    for: this.computedId,
