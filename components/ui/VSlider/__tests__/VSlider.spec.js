...
describe('VSlider.js', () => {
    ...
    beforeEach(() => {
        ...
        mountFunction = (options = {}) => mount(VSlider, {
    ...
    it('should render component with thumbLabel and match a snapshot', async () => {
        ...
        await wrapper.setProps({ thumbLabel: true });
        await wrapper.vm.$nextTick();
    ...
    it('should add for to label', () => {
        ...
        expect(label2.element.getAttribute('for')).toBe(`input-${wrapper2.vm._uid}`);
    });
    ...
    it('should change track styles in rtl', async () => {
        ...
        // wrapper.vm.$vuetify.rtl = true
        await wrapper.setProps({ value: 0, disabled: false });
        await wrapper.vm.$nextTick();
